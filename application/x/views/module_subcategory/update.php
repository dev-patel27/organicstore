                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <div class="input-icon right">
                                       ...
                                       <select class="required table-group-action-input form-control required" name="module_id" width="100%" id="" >
                                          ...
                                          <?php
...

                                             {
                                                ...
                                                $selected = ($row_c['id']==$result['1']->module_id) ? 'selected' : '';

                                                echo '<option value="'.$row_c['id'].'" '.$selected.'>'.$row_c['module_name'].'</option>';
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="form-group">
                                 ...
                                 <label class="control-label col-md-3">Sub Module name
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <div class="input-icon right">
                                       ...
                                       <input type="text" class="required form-control" value="<?= $result['1']->sub_module_name; ?>" placeholder="Sub Module Name" name="name" id="script"  />
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="row" align="center">
                                    ...
                                    <button class="btn default" onclick="cancelBtn('<?= site_url('module_subcategory/list')?>','form_sample_3')" type="button">Cancel</button>
