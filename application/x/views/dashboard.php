...
<!--<script src="http://maps.google.com/maps/api/js?sensor=true" type="text/javascript"></script>-->
  ...
  <!--<script src="https://www.google.com/maps/embed/v1/MODE?key=AIzaSyC_x9MlgWnzQ1_UNSOW6whDjO6DZU3WSZE&parameters" type="text/javascript"></script>-->
  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyC_x9MlgWnzQ1_UNSOW6whDjO6DZU3WSZE&sensor=true" type="text/javascript"></script>
...
?>
            <div class="col-lg-4 col-xs-12 col-sm-12">
               <a href="<?=ADMIN_BASE_URL . 'customers/customer-details/list'?>" class="dashboard-stat dashboard-stat-v2 blue">
                  <div class="visual">
                  ...
                  <div class="details">
                     <div class="number">
                        <span data-counter="counterup" data-value="0">
                            <i class="fa fa-cart"></i>
                             <?php
$today_customers = $this->admin_model->get_today_customers();
echo count($today_customers);
?>
                        </span>
                     </div>
                     <div class="desc"> Today Registered Customer</div>
                  </div>
               </a>
            </div>
<!--             <div class="col-lg-4 col-xs-12 col-sm-12">-->
...
<!--             <div class="col-lg-4 col-xs-12 col-sm-12">-->
<!--               <a href="--><?//=ADMIN_BASE_URL.'farm/farm-map'?><!--" class="dashboard-stat dashboard-stat-v2 green">-->
<!--                  <div class="visual">-->
<!--                     <!-- <i class="fa fa-bar-chart-o"></i> -->
<!--                  </div>-->
<!--                  <div class="details">-->
...
<!--                        </span>-->
<!--                     </div>-->
<!--                       <div class="desc"> <h3 style="margin-top: -21px;margin-bottom: 5px;margin-right: 25px;">View Farm Location Map</h3></div>-->
<!--                     -->
<!--                  </div>-->
<!--               </a>-->
<!--            </div>-->
...
?>
                <div class="bs-services divided-bs">
                     ...
                     <!-- <?=$customers_map->latitude?>,<?=$customers_map->longitude?> -->
                     <!--&output=embed" width="100%" height="300" frameborder="0" style="border:0;" allowfullscreen></iframe>
                 </div>
            </div>
         </div>-->
<!--         <div class="row">-->
...
<!--                <div class="desc"> Customers Location Map </div>        -->
...
<!--        -->
        				<?php /* === MAP DATA === */?>
        				<?php
/*                        $d_data = $this->db->select('city,latitude,longitude,COUNT(latitude) as total')
->where('status','1')
->where('latitude != ','')
->group_by('latitude')
->order_by('total','desc')
