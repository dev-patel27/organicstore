      ...
      <div class="page-content" >
         ...
         <div class="page-bar">
            ...
            <div class="page-toolbar">
               <div class="btn-group">
                  <button type="button" class="btn blue" onclick="location.href = 'add';" >Add New Role Permission</button>
               </div>
            </div>
         </div>
         <!-- END PAGE BAR -->
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'role_permission'; ?>');
