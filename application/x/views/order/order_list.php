                     ...
                     <div class="form-body filter">
                        <div class=" col-md-3">
                           ...
                           <div class="input-group">
                              <input type="text" placeholder="Order Id" class="form-control form-filter" name="order_id">
                           </div>
                           <br>
                           <label>Mobile Number</label>
                           <div class="input-group">
                              <input type="text" placeholder="Mobile no" class="form-control form-filter" name="mobile_no">
                           </div>
                        </div>
                         <div class=" col-md-3">
                           <label>Email</label>
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL . 'order-list/order-list'; ?>');
