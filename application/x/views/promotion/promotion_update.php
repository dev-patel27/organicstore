                              ...
                              <div class="col-md-9">
                                  <div class="col-md-3">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="file" placeholder="Image" name="image" id="file" enctype = "multipart/form-data" />
                                    </div>
                                 </div>
                                 <div class="col-md-6" style="float: right;">
                                    <div class="input-icon right">
                                       <img style="height: 100px;" src="<?= PROMOTION_IMG_URL .$result['1']->image?>">
                                    </div>
                                 </div>
                              </div> 
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="row" align="center">
                                    ...
                                    <button class="btn default" onclick="cancelBtn('<?= site_url('promotion/promotion/list')?>','form_sample_3')" type="button">Cancel</button>
                              </div>
                           </div>
