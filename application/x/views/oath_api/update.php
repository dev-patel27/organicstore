      ...
      <div class="page-content" >
         ...
         <div class="row">
           ...
           <?php
                 ...
                 //$store = $this->admin_model->get_stores();
                              ...
                              <?php
                                 foreach($store as $str)
                                 {
                                    ...
                                    if($this->_type == 'user')
                                    {
                                       ...
                                       {
                                          $selected = ($this->_loginData->active_store == $str['store_id'] ) ? 'selected' : '';
                                          echo '<option value="'.$str['store_id'].'" '.$selected.'>'.$str['store_name'].'</option>';
                                       }
                                    }
                                    else
                                    {
                                        $selected = ( $store_id == $str['store_id'] ) ? 'selected' : '';
                                        echo '<option value="'.$str['store_id'].'" '.$selected.'>'.$str['store_name'].'</option>';
                                    }
...
$fb_api = json_decode($result[1]->fb_api);
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Client ID" name="fb_client_id" id="" value="<?= $fb_api->fb_client_id; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Client Secret" name="fb_client_secret" id="" value="<?= $fb_api->fb_client_secret; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Authorization Base URL" name="fb_authorization_base_url" id="" value="<?= $fb_api->fb_authorization_base_url; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Token URL" name="fb_token_url" id="" value="<?= $fb_api->fb_token_url; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Redirect URL" name="fb_redirect_url" id="" value="<?= $fb_api->fb_redirect_url; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                                         ...
                                         <span class="required"> * </span>
                                          ...
                                          <div class="col-md-9">
                                             <div class="input-icon right">
                                                ...
                                                <label><input <?php echo ($result[1]->status == 1) ? 'checked' : '';?> type="radio" class="form-control required" name="status" value="1">Active</label>
                                                
                                                <label><input <?php echo ($result[1]->status != 1) ? 'checked' : '';?> type="radio" class="form-control required" name="status" value="0">Inactive</label>                    
                                             </div>
                                          </div>
                                       </div>
                                    </div>
...
$google_api = json_decode($result[1]->google_api);
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Client ID" name="google_client_id" id="" value="<?= $google_api->google_client_id; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Client Secret" name="google_client_secret" id="" value="<?= $google_api->google_client_secret; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Authorization Base URL" name="google_authorization_base_url" id="" value="<?= $google_api->google_authorization_base_url; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Token URL" name="google_token_url" id="" value="<?= $google_api->google_token_url; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Scope" name="google_scope" id="" value="<?= $google_api->google_scope; ?>" />
                                    </div>
                                 </div>
                              </div>
                           </div>
...
<script type="text/javascript">
// $('#storeusers_password, #storeusers_conf_password').on('keyup', function () {
//   if ($('#storeusers_password').val() == $('#storeusers_conf_password').val()) {
//     $('#message').html('Password and Confirm Password Matching').css('color', 'green');
//   } else 
//     $('#message').html('Password and Confirm Password Not Matching').css('color', 'red');
// });

    function Validate() {
        var password = document.getElementById("storeusers_password").value;
        var confirmPassword = document.getElementById("storeusers_conf_password").value;
