...
<div class="page-container">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="file"  class="" placeholder="" name="image" id="image" enctype = "multipart/form-data"  />
                                    </div>
                                 </div>
                              </div>
                           </div>
 ...
 -->
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Tg Name
                                 <span class="required"> * </span>
                                 </label>
                                 <div class="col-md-9">
                                    <div class="input-icon right">
                                       <i class="fa"></i>
                                       <input type="text" class="form-control required" placeholder="Tag Name" name="tag_name" id="tag_name"  />
                                    </div>
                                 </div>
                              </div>
                           </div>
