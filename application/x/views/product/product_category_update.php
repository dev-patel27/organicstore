                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                ...
                                                <img style="float: right;margin-top: -20px;" src="<? /*=PRODUCT_CATEGORY_IMG_URL . $result['1']->category_image*/ ?>" alt="" height="80px" width="100px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="row" align="center">
                                    ...
                                    <button class="btn default"
                                            onclick="cancelBtn('<?= site_url('product/category/list'); ?>','form_sample_3')"
                                            type="button">Cancel
                                    </button>
                                    <!-- </div> -->
                                </div>
