                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="file" class="required form-control allow-number-only" placeholder="Title" name="image" id="image"   />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row" align="center">
                                                ...
                                                <button class="btn default" onclick="cancelBtn('<?= site_url('product/category/list');?>','form_sample_3')" type="button">Cancel</button>
                                            </div>
                                        </div>
