      ...
      <div class="page-content" >
         <div class="page-bar">
            ...
            <div class="page-toolbar">
               <div class="btn-group">
                  <button type="button" class="btn blue" onclick="location.href = 'add';" >Add Coupon code</button>
               </div>
            </div>
         </div>
         <div class="row">
                     ...
                     <div class="form-body filter">
                        <div class="col-md-3">
                           ...
                           <div class="input-group">
                              <input type="text" placeholder="Coupon Name" class="form-control form-filter" name="coupon_name">
                           </div>
                        </div>
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'product/coupon-code'; ?>');
