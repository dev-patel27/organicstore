                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <select class="required table-group-action-input form-control required" name="category_id" width="100%" id="" >
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row" align="center">
                                            ...
                                            <button class="btn default" onclick="cancelBtn('<?= site_url('product/sub-category/list');?>','form_sample_3')" type="button">Cancel</button>
                                        </div>
                                    </div>
