        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group">
                        <button type="button" class="btn blue" onclick="location.href = 'add';">Add Category</button>
                    </div>
                </div>
            </div>
            <!-- END PAGE BAR -->
                            ...
                            <div class="form-body filter">
                                <div class=" col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="Category" class="form-control form-filter"
                                               name="category_name">
                                    </div>
                                </div>
                                ...
                                <div class=" col-md-3">
                                    ...
                                    <div class="input-group">
                                        <div data-date-format="dd/mm/yyyy"
                                            ...
                                            <input name="form_created_at" id="form_created_at" type="text"
                                 ...
                                 <i class="fa fa-calendar"></i>
                                        ...
                                        <div data-date-format="dd/mm/yyyy" class="input-group date date-picker">
                                            <input name="to_created_at" id="to_created_at" onchange="DateCheck()"
                                                   type="text" placeholder="To" readonly=""
                                                   class="form-control form-filter input-sm">
                                            <span class="input-group-btn">
                                 <button type="button" class="btn btn-sm default">
                                 <i class="fa fa-calendar"></i>
...
<script>
    $(document).ready(function () {
        TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL . 'product/category'; ?>');
