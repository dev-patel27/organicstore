...
<!-- BEGIN PAGE BAR -->
    <div class="page-bar">
        ...
        <div class="page-toolbar">
            <div class="btn-group">
                <button type="button" class="btn blue" onclick="location.href = 'add';" >Add New <?= ucfirst($this->router->fetch_class()); ?></button>
            </div>
        </div>
                        ...
                        <div class="form-body filter">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="Name" class="form-control form-filter" name="name">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label>Email</label>
                        ...
                        <div class="table-container">
                            <div class="table-actions-wrapper">
                                ...
                                <select class="table-group-action-input form-control input-inline input-small input-sm">
                                    ...
                                    <?php /*<option value="9">Delete</option>*/ ?>
                                </select>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                ...
                                <tr role="row" class="heading">
                                    <th width="1%">
                                    <input type="checkbox" class="group-checkable" id="checkbox"></th>
                                    <th width="1%">Id</th>
                                    <th width="1%">Type</th>
                                    <th width="1%">Name</th>
                                    <th width="1%">Email</th>
                                    <th width="1%">Mobile Number</th>
                                    <th width="3%">Address</th>
                                    <th width="3%">Alternate Mobile Number</th>
                                    <th width="3%">Image</th>
...
<script>
    $(document).ready(function () {
        TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'users/add-user'; ?>');
