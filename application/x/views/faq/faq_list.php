      ...
      <div class="page-content" >
         ...
         <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group">
                  <button type="button" class="btn blue" onclick="location.href = 'add';" >Add New Faq</button>
               </div> 
            </div>
         </div>
         <!-- END PAGE BAR -->
                     ...
                     <div class="form-body filter">
                        <div class=" col-md-3">
                           ...
                           <div class="input-group">
                              <input type="text" placeholder="Question" class="form-control form-filter" name="question">
                           </div>
                        </div>                    
                        <div class=" col-md-3">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                           <thead>
                              <tr role="row" class="heading">
                                 ...
                                 <th width="3%" data-sortable="false">Actions</th>
                              </tr>
                           </thead>
                           <tbody>
                           </tbody>
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'faq/add-faq'; ?>');
