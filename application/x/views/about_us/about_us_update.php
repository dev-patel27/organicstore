            ...
            <div class="portlet light">
               <div class="portlet-body form">
                  ...
                  <form action="<?= current_url(); ?>" id="form_sample_3" method="post" class="form-horizontal" enctype="multipart/form-data">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="control-label col-md-3">Description-1 <span class="required"> * </span></label>
                                  <div class="col-md-9">
                   ...
                   <button class="btn default" onclick="cancelBtn('<?= site_url('about-us/about-us/list')?>','form_sample_3')" type="button">Cancel</button>
                   <!-- </div> -->
                   </div>
                   </div>
