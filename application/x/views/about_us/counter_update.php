                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="<?= current_url(); ?>" id="form_sample_3" method="post" class="form-horizontal"
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                ...
                                                <img style="float: right;margin-top: -20px;"
                                                     src="<?= ABOUT_US_IMG_URL . $result['1']->image ?>" alt=""
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Counter Value </label>
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="tel" pattern="[0-9.]*" placeholder="Counter Value"
                                                       name="counter_value" value="<?= $result['1']->counter_value ?>"
                                                       id="counter_value" class="form-control required"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
