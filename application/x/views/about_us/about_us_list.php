        ...
        <div class="page-content" >
            ...
            <div class="page-bar">
                ...
                <div class="page-toolbar">
                    <div class="btn-group">
                        <button type="button" class="btn blue" onclick="location.href = 'add';" >Add About Us</button>
                    </div>
                </div>
            </div>
            <!-- END PAGE BAR -->
                            ...
                            <div class="form-body filter">
                                <div class=" col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" placeholder="Description" class="form-control form-filter" name="description">
                                    </div>
                                </div>
...
<script>
    $(document).ready(function () {
        TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'about-us/about-us'; ?>');
    });
</script>
