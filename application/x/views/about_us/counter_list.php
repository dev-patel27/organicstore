      ...
      <div class="page-content" >
         <div class="page-bar">
            ...
            <div class="page-toolbar">
               <div class="btn-group">
                  <button type="button" class="btn blue" onclick="location.href = 'add';" >Add Counter</button>
               </div>
            </div>
         </div>
         <div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                           <thead>
                              <tr role="row" class="heading">
                                 ...
                                 <th width="1%">Image</th>
                                 <th width="1%">Counter Title</th>
                                 <th width="1%">Counter Value</th>
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL .'about-us/counter'; ?>');
   });
</script>
