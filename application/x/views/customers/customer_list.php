      ...
      <div class="page-content" >
         ...
         <div class="page-bar">
            ...
            <div class="page-toolbar">
              <!--  <div class="btn-group">
                  <button type="button" class="btn blue" onclick="location.href = 'add';" >Add New Customer</button>
               </div> -->
            </div>
         </div>
         <!-- END PAGE BAR -->
                  ...
                  <div class="portlet-title line-border">
                     <div class="form-body filter">
                        ...
                        <div class=" col-md-3">
                           ...
                           <div class="input-group">
                              <input type="text" placeholder="Username" class="form-control form-filter" name="username">
                           </div>
                        </div>
                           <div class="col-md-3">
                        ...
                        <div class="col-md-6 margin-top-20 pull-right">
                           <div class="col-md-3">
...
<script>
   $(document).ready(function () {
       TableDatatablesAjax.init('datatable_ajax', '<?php echo ADMIN_BASE_URL . 'customers/customer-details'; ?>');
