...
{
	$config['base_url'] = 'http://localhost/organicstore/x/';
}
else
{
	$config['base_url'] = 'http://www.organic-store.in/organicstore/x/';
}
/*
|--------------------------------------------------------------------------
| Index File
...
$config['header_css'] = array(
    ...
    'css/fonts/simple-line-icons.min.css',
...
$config['header_js']  = array(
    ...
    'select2/js/components-select2.min.js',
    'js/custom.js',
    'js/app.min.js',
