...
class Module_category extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->table_name = "tbl_module_category";
        $this->dir_path = "module_category/"; 
        $this->name = "module_category";
    ...
    public function post()
    {
        ...
        if ($this->input->post()) {
                ...
                $data['module_name'] = trim($_REQUEST['name']);
                $data['slug_module_name'] = url_title(trim($_REQUEST['name']));
                $data['status'] = 1;
