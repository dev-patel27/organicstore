...
$(document).ready(function() {
        ...
        t.widget("llapgoch.stepper", {
            ...
            _validateValue: function(t) {
                return (
                    (t = parseFloat(t)),
                    (t = isNaN(t) ? 1 : t),
                    Math.max(this.options.minQty, Math.min(t, this.options.maxQty))
                );
            },
            _addEvents: function() {
                var t = this,
            ...
            _fireUpdate: function(t) {
                ...
                this.value != this.originalValue && (e = "different_value_entered"),
                    this._fireEvent("update", t, {
                        value: this.value,
                        updateType: e
                    });
            },
            ...
            updateQuantity: function(t) {
                (this.value = this._validateValue(t)),
    ...
    jQuery(document).on("ready", function() {
        jQuery(".stepper-widget").stepper(),
            jQuery(".stepper-widget").on("stepperupdate", function(t, e) {
