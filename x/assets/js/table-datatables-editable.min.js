var TableDatatablesEditable = function() {
    var e = function() {
        ...
        $("#sample_editable_1_new").click(function(e) {
            ...
            null !== r && r != o ? (e(l, r), t(l, o), r = o) : r == o && "Save" == this.innerHTML ? (n(l, r), r = null, alert("Updated! Do not forget to do some ajax to sync with backend :)")) : (t(l, o), r = o)
        })
    };
    return {
        init: function() {
