var App = function() {
    var t, e = !1,
        ...
        U = function() {
            ...
            jQuery.fancybox && $(".fancybox-button").fancybox({
                groupAttr: "data-rel",
                prevEffect: "none",
                nextEffect: "none",
                closeBtn: !0,
    ...
    return {
        init: function() {
            h(), u(), g(), b(), m(), v(), T(), U(), G(), f(), A(), I(), k(), x(), P(), C(), w(), y(), S(), D(), this.addResizeHandler(H), E()
        },
        initAjax: function() {
            b(), m(), v(), z(), T(), G(), U(), I(), x(), P(), C(), y()
        },
