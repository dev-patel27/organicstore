    ...
    var e = function() {
        ...
        i = function() {
            ...
            e.on("submit", function() {
                ...
                invalidHandler: function(e, t) {
                    i.hide(), r.hide(), App.scrollTo(r, -200)
                },
                highlight: function(e) {
                    //$(e).closest(".form-group").addClass("has-error")
                    $(e).closest(".form-group").removeClass("has-success").addClass("has-error")
        ...
        j = function() {
            ...
            e.on("submit", function() {
                ...
                rules: {
                    hotline_name_0: {
                        required: function(element) {
                            if ($("#hotline_name_1").val().length > 0) {
                                return false;
                            }
                            else {
                                return true;
                    ...
                    hotline_name_1: {
                        required: function(element) {
                            if ($("#hotline_name_0").val().length > 0) {
                                return false;
                            }
                            else {
                                return true;
