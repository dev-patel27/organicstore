    ...
    return {
        ...
        init: function(options) {
          ...
          /*  table.on('click', '.filter-submit', function(e) {
            ...
            $('.filter .filter-submit').on('click', function(e) {
           ...
           /* table.on('click', '.filter-cancel', function(e) {
            ...
            $('.filter .filter-cancel').on('click', function(e) {
        ...
        submitFilter: function() {
            ...
            $('textarea.form-filter, select.form-filter, input.form-filter:not([type="radio"],[type="checkbox"])', $('.filter') ).each(function() {
