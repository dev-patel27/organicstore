...
require_once "./php5/CommandHandler/CommandHandlerBase.php";
/**
 * singleton factory
 */
require_once "./php5/Core/Factory.php";
/**
 * utils class
 */
require_once "./php5/Utils/Misc.php";
/**
 * hooks class
 */
require_once "./php5/Core/Hooks.php";
/**
