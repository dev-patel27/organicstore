...
! function(a) {
    ...
    ! function() {
        ...
        a.validator.addMethod("greaterThan", function(value, element, params) {

            if(Date.parse(new Date(value.replace(/-/g, '/'))) <= Date.parse( new Date($(params).val().replace(/-/g, '/')) )){
        ...
        a.validator.addMethod("price", function(a, b) {
            return this.optional(b) || /^(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(a)
        }, "Decimal only please"),

            a.validator.addMethod("contactNo", function(a, b) {
                return this.optional(b) || /^(?=.*[0-9])[- +()0-9]+$/.test(a)
            }, "Please enter a valid contact number"),

        a.validator.addMethod("strongpassword", function(a, b) {
            return this.optional(b) || /^(?=.*?[A-Za-z])(?=.*?[0-9])(?=.*?[^\w\s]).{8,}$/.test(a)
        }, "At least 8 characters, 1 Letter, 1 number and 1 special character please"),
